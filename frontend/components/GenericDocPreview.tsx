...
import type { DocTemplate, FormValues } from '@/lib/renderTemplate'
...
const GenericDocPreview = forwardRef<HTMLDivElement, GenericDocPreviewProps>(
  ({ template, values }, ref) => {
    return (
      <div
        ref={ref}
      ...
      >
        ...
        <div className="text-center mb-8">
          <h1 className="text-xl font-bold uppercase tracking-wide">{template.name}</h1>
...
GenericDocPreview.displayName = 'GenericDocPreview'

export default GenericDocPreview
