...
import { cloudServiceAgreementTemplate } from '@/lib/cloudServiceAgreementTemplate'
import { renderSection } from '@/lib/renderTemplate'
import type { FormValues } from '@/lib/renderTemplate'
import SignatureSection from './SignatureSection'

interface CloudServiceAgreementPreviewProps {
  values: FormValues
}

const CloudServiceAgreementPreview = forwardRef<HTMLDivElement, CloudServiceAgreementPreviewProps>(
  ({ values }, ref) => {
    return (
      <div
        ref={ref}
      ...
      >
        ...
        <div className="text-center mb-8">
          <h1 className="text-xl font-bold uppercase tracking-wide">Cloud Service Agreement</h1>
        ...
        <div className="space-y-5 text-sm leading-relaxed">
          {cloudServiceAgreementTemplate.sections.map((section) => {
...
CloudServiceAgreementPreview.displayName = 'CloudServiceAgreementPreview'

export default CloudServiceAgreementPreview
